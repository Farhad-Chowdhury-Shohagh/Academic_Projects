...
def get_category(food_name):
    ...
    if any(x in name for x in [
        "coffee", "tea", "juice", "milkshake",
        "shake", "lassi", "lemonade"
    ]):
        return "Beverage"

    if any(x in name for x in [
        "cake", "ice cream", "brownie",
        "cheesecake", "donut", "muffin", "faluda"
    ]):
        return "Dessert"
    ...
    if any(x in name for x in [
        "biryani", "rice", "khichuri",
        "khichdi", "tehari", "pulao"
    ]):
        return "Rice Meal"
